...
# First level start-code
def run_code(questions):
    score = 0
    ...
    if score > 7:                                                    # Finish 1st level with some comment
        ...
        if score > 12:                                                 # Demonstration of the result
            ...
            print(f"""You got {lev_two_score} / {len(questions_lv_two)
                                                 }, ---WELL DONE---, You are very smart person...""")
        elif score <= 10:
            print(f"""You got {lev_two_score} / {len(questions_lv_two)
                                                 }. In total you earned {score} scores.""")
